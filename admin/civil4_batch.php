...
?>
   ...
   <div id="main22">
      ...
      <div id="batch"> 
         ...
         <a href="civil.php"> 1st Batch </a>
         <a href="civil2_batch.php"> 2nd Batch </a>
         <a href="civil3_batch.php"> 3rd Batch </a>
         <a href="civil4_batch.php"> 4th Batch </a>
...
echo "<script> alert('empty not allowed') </script>";
    ...
    $x="INSERT INTO civil_4th_batch_student(name,roll,reg,gender,contact,address) values ('$name','$roll','$reg','$gender','$contact','$address')";
