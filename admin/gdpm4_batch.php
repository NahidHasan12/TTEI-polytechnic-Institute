...
?>
   ...
   <div id="main22">
       <h1> GDPM Department </h1>

 <div id="batch"> 

         <a href="gdpm.php"> 1st Batch </a>
         <a href="gdpm2_batch.php"> 2nd Batch </a>
         <a href="gdpm3_batch.php"> 3rd Batch </a>
         <a href="gdpm4_batch.php"> 4th Batch </a>

       </div>


       <div id="main221"> 
          <h2> Insert Fourth Batch Student </h2>
...
echo "<script> alert('empty not allowed') </script>";
    ...
    $x="INSERT INTO gdpm_4th_batch_student(name,roll,reg,gender,contact,address) values ('$name','$roll','$reg','$gender','$contact','$address')";
