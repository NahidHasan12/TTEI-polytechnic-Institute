  ...
  if ($_SERVER['REQUEST_METHOD']=='POST') {
    ...
    $address3 = $db->validate($_POST['address']);
     ...
     if (empty($name3) || empty($roll3) || empty($reg3) || empty($gender3) || empty($contact3) || empty($address3)){
          ...
          echo "<script> alert('empy not allowed') </script>";
     }
     else{

         $x="INSERT INTO cmt_4th_batch_student(name,roll,reg,gender,contact,address) values ('$name3','$roll3','$reg3','$gender3','$contact3','$address3')";
