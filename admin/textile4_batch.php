...
?>
 ...
 <div id="batch"> 
         ...
         <a href="textile.php"> 1st Batch </a>
         <a href="textile2_batch.php"> 2nd Batch </a>
         <a href="textile3_batch.php"> 3rd Batch </a>
         <a href="textile4_batch.php"> 4th Batch </a>
...
echo "<script> alert('empty not allowed') </script>";
    ...
    $x="INSERT INTO textile_4th_batch_student(name,roll,reg,gender,contact,address) values ('$name','$roll','$reg','$gender','$contact','$address')";
